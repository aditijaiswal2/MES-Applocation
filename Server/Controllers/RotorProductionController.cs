        ...
        public async Task<IActionResult> AddSalesData([FromBody] productiondataSubmission submission)
        {
            ...
            try
            {
                var rotorData = new RotorProductionData
                {
                    ...
                    ProductionPlanningStatus = submission.ProductionPlanningStatus,
                    AdvancedSharpingStatus = string.IsNullOrWhiteSpace(submission.AdvancedSharpingStatus) ? "N/A" : submission.AdvancedSharpingStatus,
                    ProductionSavedDate = DateTime.UtcNow,
